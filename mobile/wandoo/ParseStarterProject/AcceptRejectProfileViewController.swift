//
//  AcceptRejectProfileViewController.swift
//  Wandoo
//
//  Created by Brian Kwon on 2/2/16.
//  Copyright © 2016 Parse. All rights reserved.
//

import UIKit

class AcceptRejectProfileViewController: UIViewController {
    
    var interestedInfo: NSDictionary!
    ...
    override func viewDidLoad() {
        ...
        let userID = self.interestedInfo["userID"] as! Int
